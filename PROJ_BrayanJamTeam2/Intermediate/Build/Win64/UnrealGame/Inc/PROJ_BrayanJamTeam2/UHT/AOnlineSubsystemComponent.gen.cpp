...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ParentRef_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_ParentRef;
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAOnlineSubsystemComponent_Statics::NewProp_ParentRef_MetaData[] = {
		{ "ModuleRelativePath", "AOnlineSubsystemComponent.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAOnlineSubsystemComponent_Statics::NewProp_ParentRef = { "ParentRef", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UAOnlineSubsystemComponent, ParentRef), Z_Construct_UClass_ACharacter_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAOnlineSubsystemComponent_Statics::NewProp_ParentRef_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAOnlineSubsystemComponent_Statics::NewProp_ParentRef_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAOnlineSubsystemComponent_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAOnlineSubsystemComponent_Statics::NewProp_ParentRef,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAOnlineSubsystemComponent_Statics::ClassParams = {
		...
		DependentSingletons,
		FuncInfo,
		Z_Construct_UClass_UAOnlineSubsystemComponent_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		UE_ARRAY_COUNT(FuncInfo),
		UE_ARRAY_COUNT(Z_Construct_UClass_UAOnlineSubsystemComponent_Statics::PropPointers),
		0,
		0x00B000A4u,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PROJ_BrayanJamTeam2_Source_PROJ_BrayanJamTeam2_AOnlineSubsystemComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAOnlineSubsystemComponent, UAOnlineSubsystemComponent::StaticClass, TEXT("UAOnlineSubsystemComponent"), &Z_Registration_Info_UClass_UAOnlineSubsystemComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAOnlineSubsystemComponent), 3088150210U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PROJ_BrayanJamTeam2_Source_PROJ_BrayanJamTeam2_AOnlineSubsystemComponent_h_3919252765(TEXT("/Script/PROJ_BrayanJamTeam2"),
